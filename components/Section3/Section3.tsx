        ...
        <div className="flex flex-col w-full h-full">
          ...
          <ul className="flex flex-col lg:flex-row w-full h-full justiy-between items-center">
            <FadeInDown twClass="flex flex-col md:w-3/4 xs:mx-4 h-full justify-start items-center">
              <li className="h-72 lg:w-full xs:w-3/4 w-full flex flex-col justify-center items-center my-8 bg-[#000]/10 rounded-xl text-center 2xl:px-8 lg:px-4 px-8">
            ...
            >
              <li className="h-72 lg:w-full xs:w-3/4 w-full flex flex-col justify-center items-center my-8 bg-[#000]/10 rounded-xl text-center 2xl:px-8 lg:px-4 px-8">
                ...
                <p className="cr-text mt-4">
                  Cherry will recommend products based on the user’s browsing
            ...
            >
              <li className="h-72 lg:w-full xs:w-3/4 w-full flex flex-col justify-center items-center my-8 bg-[#000]/10 rounded-xl text-center 2xl:px-8 lg:px-4 px-8">
                ...
                <p className="cr-text mt-4">
                  Cherry will automatically find and alert the user of deals
                  based on saved items, preferred brands and browsing history
                </p>
              </li>
            </FadeInDown>
          </ul>
