      ...
      <div className="cr-section-gap container flex flex-col w-full h-full">
        ...
        <div className="cr-content-mt flex flex-col w-full h-full">
          <ul className="flex flex-col lg:flex-row w-full h-full justiy-between items-center">
            <li className="relative md:w-2/4 xs:mx-4 lg:h-[20rem] xs:h-[18rem] h-[16rem] lg:w-full xs:w-80 w-full flex flex-col justify-start items-center my-8 bg-[#00000011] rounded-xl text-center 2xl:pt-20 lg:pt-12 pt-16 lg:px-4 px-8">
              ...
              <h3 className="cr-section-subTitle cr-main-color 2xl:h-[40%] h-[40%]">
                AUTOMATIC COUPONS
              </h3>
